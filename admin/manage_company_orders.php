...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if ($action === 'produce') {
        ...
        // Mengubah status pesanan menjadi shipped
...
<html>
<head>
    <title>Pengelolaan Pesanan Perusahaan - Admin - Percetakan Orieska</title>
    <meta charset="utf-8">
...
<nav class="navbar navbar-dark bg-dark">
    ...
    <div class="main-content">
        ...
        <div class="content">
      <h2>Pengelolaan Pesanan Perusahaan</h2>
      <table>
          <tr>
              <th>Order ID</th>
              <th>Username</th>
          ...
          <?php foreach ($orders as $order): ?>
              <tr>
                  ...
                  <td><?= $order['status'] ?></td>
                  <td>
                      <form method="post" action="manage_company_orders.php">
