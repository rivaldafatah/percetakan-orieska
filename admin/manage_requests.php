...
$stmt = $conn->prepare("SELECT * FROM requests ORDER BY request_date DESC");
$stmt->execute();
...
<html>
<head>
    <title>Pengelolaan Permintaan Stok Bahan - Admin - Percetakan Orieska</title>
    <meta charset="utf-8">
        ...
        <table>
            ...
            <?php foreach ($requests as $request): ?>
                <tr>
                    ...
                    <td>
                        <a class="btn btn-primary" href="print_request.php?request_id=<?= $request['id'] ?>" role="button" target="_blank">Print</a>
                    </td>
                </tr>
            <?php endforeach; ?>
        </table>
