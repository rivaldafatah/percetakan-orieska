...
$stmt = $conn->prepare("SELECT * FROM users WHERE role = 'individual'");
$stmt->execute();
...
<html>
<head>
    <title>Pengelolaan Akun Perorangan - Admin - Percetakan Orieska</title>
    <meta charset="utf-8">
...
<nav class="navbar navbar-dark bg-dark">
    ...
    <div class="main-content">
        ...
        <div class="content">
          <h2>Pengelolaan Akun Perorangan</h2>
          <table>
              <tr>
                  <th>User ID</th>
                  <th>Username</th>
