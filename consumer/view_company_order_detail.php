...
if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_FILES['design_file'])) {
    ...
    if (!in_array($file_extension, $allowed_extensions)) {
        ...
        header("Location: view_company_order_detail.php?id=$order_id");
        exit();
    }
...
if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_POST['status_action'])) {
    ...
    if ($status_action == 'approve') {
        ...
        header("Location: company_request_changes.php?id=$order_id");
        exit();
    }
}
?>
            ...
            <div class="col-md-8">
                <div class="card">
                    <div class="card-body">
                            ...
                            <table class="table table-bordered">
                                ...
                                <tbody>
                                    <tr>
                                        ...
                                        <td>
                                            <form method="post" action="view_company_order_detail.php?id=<?= $order['id'] ?>">
                        ...
                        <?php endif; ?>
                        <a class="btn btn-success" href="print_company_invoice.php?order_id=<?= $order['id'] ?>" target="_blank">Cetak Invoice</a>
                        <a class="btn btn-secondary" href="company_order_history.php">Kembali</a><br><br>

                        <?php if ($order['status'] === 'rejected'): ?>
                            <form method="post" action="view_company_order_detail.php?id=<?= $order['id'] ?>" enctype="multipart/form-data">
                                <div class="mb-3">
