                    ...
                    <table>
                        <tr>
                            ...
                            <td>
                                ...
                                <?php elseif ($order['status'] === 'proofing pending'): ?>
                                    <span class="badge bg-warning">Desain Proofing Pending</span>
                                <?php elseif ($order['status'] === 'proofing approved'): ?>
                                    <span class="badge bg-success">Desain Proofing Disetujui</span>
